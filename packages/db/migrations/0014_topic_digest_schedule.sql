...
-- New columns for digest scheduling
ALTER TABLE topics ADD COLUMN digest_schedule_enabled boolean NOT NULL DEFAULT true;
COMMENT ON COLUMN topics.digest_schedule_enabled IS 'Whether scheduled digests are enabled for this topic';

ALTER TABLE topics ADD COLUMN digest_interval_minutes integer NOT NULL DEFAULT 1440;
...
ALTER TABLE topics ADD COLUMN digest_mode text NOT NULL DEFAULT 'normal';
...
ALTER TABLE topics ADD COLUMN digest_depth integer NOT NULL DEFAULT 50;
...
ALTER TABLE topics ADD COLUMN digest_cursor_end timestamptz;
