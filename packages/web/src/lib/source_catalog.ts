...
export const SOURCE_CATALOG: Record<SupportedSourceType, SourceCatalogEntry> = {
  ...
  podcast: {
    sourceType: "podcast",
    name: "Podcast",
    description: "Subscribe to podcast RSS feeds with episode metadata.",
    category: "media",
    tags: ["podcast", "audio", "episodes", "rss"],
    isPaid: false,
    isExperimental: false,
    isBudgetSensitive: false,
  },
  substack: {
    sourceType: "substack",
    name: "Substack",
    description: "Subscribe to Substack newsletters and publications.",
    category: "news",
    tags: ["substack", "newsletter", "blog", "writing"],
    isPaid: false,
    isExperimental: false,
    isBudgetSensitive: false,
  },
  medium: {
    sourceType: "medium",
    name: "Medium",
    description: "Follow Medium publications and authors.",
    category: "news",
  ...
  arxiv: {
    sourceType: "arxiv",
    name: "arXiv",
    description: "Track research papers from arXiv by category (cs.AI, cs.LG, etc.).",
    category: "news",
    tags: ["arxiv", "research", "papers", "academia", "ai", "ml"],
    isPaid: false,
    isExperimental: false,
    isBudgetSensitive: false,
  },
  lobsters: {
    sourceType: "lobsters",
    name: "Lobste.rs",
    description: "Computing-focused community with curated tech discussions.",
    category: "forums",
    tags: ["lobsters", "tech", "programming", "community"],
    isPaid: false,
    isExperimental: false,
    isBudgetSensitive: false,
  },
  producthunt: {
    ...
    name: "Product Hunt",
    description: "Discover new products and startups from Product Hunt.",
    category: "news",
    tags: ["producthunt", "startups", "products", "launches"],
    isPaid: false,
    isExperimental: false,
    isBudgetSensitive: false,
  },
  github_releases: {
    ...
    description: "Track releases from GitHub repositories.",
    category: "news",
    tags: ["github", "releases", "open source", "software"],
    isPaid: false,
    isExperimental: false,
    isBudgetSensitive: false,
  },
  telegram: {
    sourceType: "telegram",
    name: "Telegram",
    description: "Fetch messages from public Telegram channels (requires bot setup).",
    category: "social",
    tags: ["telegram", "messaging", "channels", "crypto"],
    isPaid: false,
    isExperimental: true,
    isBudgetSensitive: false,
    costHint: "Requires Telegram bot as channel admin",
  },
};
