...
function buildPromptTemplate(params: {
  ...
  return [
    ...
    "Requirements:",
    "1. You must perform web verification yourself for any fact that affects rankings or actions.",
    "2. For verified facts, include source + date context (or item-ID appendix if selected).",
    "3. If a claim cannot be verified, exclude it from recommendations/rankings and move it to an 'Excluded as unverified' section.",
    "4. Do not ask the user to verify data manually.",
    "5. Keep this educational and risk-first (not personalized financial advice).",
    "6. End with a concise action plan (decisions and monitoring triggers only).",
