...
async function handleRunWindowJob(
  ...
  try {
    ...
    const llmConfig: LlmRuntimeConfig = {
      ...
      triageReasoningEffort: llmSettings.triage_reasoning_effort ?? llmSettings.reasoning_effort,
      summaryReasoningEffort: llmSettings.summary_reasoning_effort ?? llmSettings.reasoning_effort,
