...
- We still use Grok as the *access method* for now because the official X API is not price/UX-friendly.
...
- Reuse the existing Grok “x_search” provider code if possible, but avoid naming everything “signal_*”.
