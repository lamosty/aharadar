...
### Secondary goals
- Provide explanations: *why this item/cluster is shown* (“Because you liked X and this is similar; also trending across sources”).
...
- **Goal:** run *the same stack* as production using Docker Compose
